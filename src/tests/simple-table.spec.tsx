...
test(`[SimpleTable Component]: Should contain table head cells in correct order`, async () => {
    ...
    const nodes = screen.querySelectorAll('thead tr td') as ArrayLike<HTMLTableColElement>
...
test(`[SimpleTable Component]: Should contain table cells in correct order`, async () => {
    ...
    const nodes = screen.querySelectorAll('[data-test-id]') as ArrayLike<HTMLTableColElement>
